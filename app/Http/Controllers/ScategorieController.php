...
class ScategorieController extends Controller
{
    ...
    {
        try {
            $scategories=Scategorie::with('categorie')->get(); // Inclut la catégorie liée;// categorie ici c'est le nom de la relation 
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json("insertion impossible {$e->getMessage()},404");
            }
    }
    ...
    public function destroy(Scategorie $scategorie)
    {
        try {
            ...
            return response()->json("Suppression impossible 404 {$e->getMessage()}");
            }
    }
